...
# Let agnoster handle virtualenv prompt
export VIRTUAL_ENV_DISABLE_PROMPT=1

# Current working directory
AGNOSTER_DIR_FG=$CYBERPUNK_COLOR_BLACK_1
AGNOSTER_DIR_BG=$CYBERPUNK_COLOR_RED_1

# user@host
AGNOSTER_CONTEXT_FG=$CYBERPUNK_COLOR_WHITE_1
AGNOSTER_CONTEXT_BG=$CYBERPUNK_COLOR_BLACK_1

# Git related
AGNOSTER_GIT_CLEAN_FG=$CYBERPUNK_COLOR_BLACK_1
AGNOSTER_GIT_CLEAN_BG=$CYBERPUNK_COLOR_CYAN_1
AGNOSTER_GIT_DIRTY_FG=$CYBERPUNK_COLOR_BLACK_1
AGNOSTER_GIT_DIRTY_BG=$CYBERPUNK_COLOR_YELLOW_1

# Bazaar related
AGNOSTER_BZR_CLEAN_FG=$CYBERPUNK_COLOR_BLACK_1
AGNOSTER_BZR_CLEAN_BG=$CYBERPUNK_COLOR_CYAN_1
AGNOSTER_BZR_DIRTY_FG=$CYBERPUNK_COLOR_BLACK_1
AGNOSTER_BZR_DIRTY_BG=$CYBERPUNK_COLOR_YELLOW_1

# Mercurial related
AGNOSTER_HG_NEWFILE_FG=$CYBERPUNK_COLOR_WHITE_1
AGNOSTER_HG_NEWFILE_BG=$CYBERPUNK_COLOR_RED_1
AGNOSTER_HG_CHANGED_FG=$CYBERPUNK_COLOR_BLACK_1
AGNOSTER_HG_CHANGED_BG=$CYBERPUNK_COLOR_YELLOW_1
AGNOSTER_HG_CLEAN_FG=$CYBERPUNK_COLOR_BLACK_1
AGNOSTER_HG_CLEAN_BG=$CYBERPUNK_COLOR_CYAN_1

# VirtualEnv colors
AGNOSTER_VENV_FG=$CYBERPUNK_COLOR_YELLOW_1
AGNOSTER_VENV_BG=$CYBERPUNK_COLOR_BLUE_1

# AWS Profile colors
AGNOSTER_AWS_PROD_FG=$CYBERPUNK_COLOR_BLACK_1
AGNOSTER_AWS_PROD_BG=$CYBERPUNK_COLOR_YELLOW_1
AGNOSTER_AWS_FG=$CYBERPUNK_COLOR_BLACK_1
AGNOSTER_AWS_BG=$CYBERPUNK_COLOR_CYAN_1

# Status symbols
AGNOSTER_STATUS_RETVAL_FG=$CYBERPUNK_COLOR_RED_1
AGNOSTER_STATUS_ROOT_FG=$CYBERPUNK_COLOR_YELLOW_1
AGNOSTER_STATUS_JOB_FG=$CYBERPUNK_COLOR_CYAN_1
AGNOSTER_STATUS_FG=$CYBERPUNK_COLOR_WHITE_1
AGNOSTER_STATUS_BG=$CYBERPUNK_COLOR_BLACK_1
